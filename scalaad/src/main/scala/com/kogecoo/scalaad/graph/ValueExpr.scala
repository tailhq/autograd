...
import com.kogecoo.scalaad.op.{Add00, Div00, Eq00, Gt00, Gte00, Lt00, Lte00, MatMul22, Mul00, Neg0, Neq00, Pos0, Sub00}
...
object ValueExpr {
  ...
  implicit class RichValueExpr0(val self: V0) extends AnyVal {
    ...
    def :+(rhs: V2)(implicit d: DummyImplicit): V2 = Broadcast02(self, rhs, Add00)
    def :-(rhs: V2)(implicit d: DummyImplicit): V2 = Broadcast02(self, rhs, Sub00)
    def :*(rhs: V2)(implicit d: DummyImplicit): V2 = Broadcast02(self, rhs, Mul00)
    def :/(rhs: V2)(implicit d: DummyImplicit): V2 = Broadcast02(self, rhs, Div00)

    def unary_+(): V0 = Apply0(self, Pos0)
    def unary_-(): V0 = Apply0(self, Neg0)

    def ==(rhs: V0): B0 = Apply00C(self, rhs, Eq00)
    def !=(rhs: V0): B0 = Apply00C(self, rhs, Neq00)
    def < (rhs: V0): B0 = Apply00C(self, rhs, Lt00)
    def <=(rhs: V0): B0 = Apply00C(self, rhs, Lte00)
    def > (rhs: V0): B0 = Apply00C(self, rhs, Gt00)
    def >=(rhs: V0): B0 = Apply00C(self, rhs, Gte00)

    def :==(rhs: V1): B1 = Broadcast01C(self, rhs, Eq00)
    def :!=(rhs: V1): B1 = Broadcast01C(self, rhs, Neq00)
    def :< (rhs: V1): B1 = Broadcast01C(self, rhs, Lt00)
    def :<=(rhs: V1): B1 = Broadcast01C(self, rhs, Lte00)
    def :> (rhs: V1): B1 = Broadcast01C(self, rhs, Gt00)
    def :>=(rhs: V1): B1 = Broadcast01C(self, rhs, Gte00)

    def :==(rhs: V2)(implicit d: DummyImplicit): B2 = Broadcast02C(self, rhs, Eq00)
    def :!=(rhs: V2)(implicit d: DummyImplicit): B2 = Broadcast02C(self, rhs, Neq00)
    def :< (rhs: V2)(implicit d: DummyImplicit): B2 = Broadcast02C(self, rhs, Lt00)
    def :<=(rhs: V2)(implicit d: DummyImplicit): B2 = Broadcast02C(self, rhs, Lte00)
    def :> (rhs: V2)(implicit d: DummyImplicit): B2 = Broadcast02C(self, rhs, Gt00)
    def :>=(rhs: V2)(implicit d: DummyImplicit): B2 = Broadcast02C(self, rhs, Gte00)
  ...
  implicit class RichValueExpr1(val self: V1) extends AnyVal {
    ...
    def ==(rhs: V1): B1 = { check(rhs, "Eq11" ); Elementwise11C(self, rhs, Eq00)  }
    def !=(rhs: V1): B1 = { check(rhs, "Neq11"); Elementwise11C(self, rhs, Neq00) }
    def < (rhs: V1): B1 = { check(rhs, "Lt11" ); Elementwise11C(self, rhs, Lt00)  }
    def <=(rhs: V1): B1 = { check(rhs, "Lte11"); Elementwise11C(self, rhs, Lte00) }
    def > (rhs: V1): B1 = { check(rhs, "Gt11" ); Elementwise11C(self, rhs, Gt00)  }
    def >=(rhs: V1): B1 = { check(rhs, "Gte11"); Elementwise11C(self, rhs, Gte00) }

    def :==(rhs: V0): B1 = Broadcast10C(self, rhs, Eq00 )
    def :!=(rhs: V0): B1 = Broadcast10C(self, rhs, Neq00)
    def :< (rhs: V0): B1 = Broadcast10C(self, rhs, Lt00 )
    def :<=(rhs: V0): B1 = Broadcast10C(self, rhs, Lte00)
    def :> (rhs: V0): B1 = Broadcast10C(self, rhs, Gt00 )
    def :>=(rhs: V0): B1 = Broadcast10C(self, rhs, Gte00)
  ...
  implicit class RichValueExpr2(val self: V2) extends AnyVal {
    ...
    def :+(rhs: V0): V2 = Broadcast20(self, rhs, Add00)
    def :-(rhs: V0): V2 = Broadcast20(self, rhs, Sub00)
    def :*(rhs: V0): V2 = Broadcast20(self, rhs, Mul00)
    def :/(rhs: V0): V2 = Broadcast20(self, rhs, Div00)
    ...
    */
    ...
    def ==(rhs: V2): B2 = { check(rhs, "Eq22" ); Elementwise22C(self, rhs, Eq00)  }
    def !=(rhs: V2): B2 = { check(rhs, "Neq22"); Elementwise22C(self, rhs, Neq00) }
    def < (rhs: V2): B2 = { check(rhs, "Lt22" ); Elementwise22C(self, rhs, Lt00)  }
    def <=(rhs: V2): B2 = { check(rhs, "Lte22"); Elementwise22C(self, rhs, Lte00) }
    def > (rhs: V2): B2 = { check(rhs, "Gt22" ); Elementwise22C(self, rhs, Gt00)  }
    def >=(rhs: V2): B2 = { check(rhs, "Gte22"); Elementwise22C(self, rhs, Gte00) }

    def :==(rhs: V0): B2 = Broadcast20C(self, rhs, Eq00)
    def :!=(rhs: V0): B2 = Broadcast20C(self, rhs, Neq00)
    def :< (rhs: V0): B2 = Broadcast20C(self, rhs, Lt00)
    def :<=(rhs: V0): B2 = Broadcast20C(self, rhs, Lte00)
    def :> (rhs: V0): B2 = Broadcast20C(self, rhs, Gt00)
    def :>=(rhs: V0): B2 = Broadcast20C(self, rhs, Gte00)
