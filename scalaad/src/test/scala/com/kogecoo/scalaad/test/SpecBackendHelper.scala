...
object SpecBackendHelper {
  ...
  case class ToT0[T0](toT0: N0 => T0)
  case class ToT1[T1](toT1: N1 => T1)
  case class ToT2[T2](toT2: N2 => T2)

  object Implicits {

    implicit class N0Ops[T0](val self: N0) extends AnyVal {
    ...
    implicit class N1Ops[T0, T1](val self: N1) extends AnyVal {
    ...
    implicit class N2Ops[T0, T2](val self: N2) extends AnyVal {
