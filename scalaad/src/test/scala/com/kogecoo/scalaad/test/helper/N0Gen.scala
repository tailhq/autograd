...
abstract class N0Gen[T] {
  ...
  final def genNode0(valueGen: Gen[T]): Gen[VE0] = {
    Gen.oneOf(
      genVar0(valueGen),
      genConst0(valueGen),
      genZero0(),
  ...
  final def genNonzeroNode0(valueGen: Gen[T]): Gen[VE0] = {
    Gen.oneOf(
      genVar0(valueGen),
      genConst0(valueGen),
      genHalf0(),
  ...
  final def genNonVar0(valueGen: Gen[T]): Gen[VE0] = {
    Gen.oneOf(
      genConst0(valueGen),
      genZero0(),
      genHalf0(),
  ...
  final def genNonzeroNonVar0(valueGen: Gen[T]): Gen[VE0] = {
    Gen.oneOf(
      genConst0(valueGen),
      genHalf0(),
      genOne0()
