...
import com.kogecoo.scalaad.graph.{V1, V2, Pow11, Var1}
...
object StdPow11Spec extends Properties("Pow11") with Pow11Spec with StdSpecBackend {
  ...
  override def expectApplyOp(a: V1, b: V1): T1 = elementwise1(a.toT1, b.toT1, math.pow)
...
trait Pow11Spec extends BinaryOp11SpecBase { self: Properties with SpecBackend =>
  ...
  override def op(a: V1, b: V1): V1 = Pow11(a, b)
