...
/*
  ...
  implicit val eval22_nd4j_matrix_double: Eval[V2, INDArray] = new Eval[V2, INDArray] {
    ...
    def eval(n: N): V = n match {
      ...
      // Binary ops
      case Add02(l: V0, r: N)  => r.eval[V].add(l.eval[T])  // FIXME: this assuming commutative law
      case Add20(l: N , r: V0) => l.eval[V].add(r.eval[T])
      case Add22(l: N , r: N)  => l.eval[V].add(r.eval[V])

      case Sub02(l: V0, r: N)  => r.eval[V].rsub(l.eval[T])
      case Sub20(l: N , r: V0) => l.eval[V].sub(r.eval[T])
      case Sub22(l: N , r: N)  => l.eval[V].sub(r.eval[V])

      case Mul02(l: V0, r: N)  => r.eval[V].mul(l.eval[T])  // FIXME: this assuming commutative law
      case Mul20(l: N , r: V0) => l.eval[V].mul(r.eval[T])
      case Mul22(l: N , r: N)  => l.eval[V].mul(r.eval[V])

      case Div02(l: V0, r: N)  => r.eval[V].rdiv(l.eval[T])
      case Div20(l: N , r: V0) => l.eval[V].div(r.eval[T])
      ...
      case Pow02(l: V0, r: N)  => Nd4jUtil.pow(l.eval[T], r.eval[V])
      case Pow20(l: N , r: V0) => Nd4jUtil.pow(l.eval[V], r.eval[T])
      case Pow22(l: N , r: N)  => Nd4jUtil.pow(l.eval[V], r.eval[V])

      case Abs2(v)                => v.eval[V].map(math.abs)
      case Max02(l: V0   , r: N)  => Nd4jUtil.max(r.eval[V], l.eval[T])
      case Max20(l: N    , r: V0) => Nd4jUtil.max(l.eval[V], r.eval[T])
      case Max22(l: N    , r: N)  => Nd4jUtil.max(l.eval[V], r.eval[V])
      case Min02(l: V0   , r: N)  => Nd4jUtil.min(r.eval[V], l.eval[T])
      case Min20(l: N    , r: V0) => Nd4jUtil.min(l.eval[V], r.eval[T])
  ...
  implicit val eval_bool22_nd4j_matrix_double: Eval[B2, INDArray] = new Eval[B2, INDArray] {
    ...
    def eval(n: B2): INDArray = n match {
      case Eq02(l: V0, r: V2)  => Nd4jUtil.eq(r.eval[V], l.eval[T])
      case Eq20(l: V2, r: V0)  => Nd4jUtil.eq(l.eval[V], r.eval[T])
      case Eq22(l: V2, r: V2)  => Nd4jUtil.eq(l.eval[V], r.eval[V])
      case Neq02(l: V0, r: V2) => Nd4jUtil.neq(r.eval[V], l.eval[T])
      case Neq20(l: V2, r: V0) => Nd4jUtil.neq(l.eval[V], r.eval[T])
      case Neq22(l: V2, r: V2) => Nd4jUtil.neq(l.eval[V], r.eval[V])
      case Lt02(l: V0, r: V2)  => Nd4jUtil.gt(r.eval[V], l.eval[T])
      case Lt20(l: V2, r: V0)  => Nd4jUtil.lt(l.eval[V], r.eval[T])
      case Lt22(l: V2, r: V2)  => Nd4jUtil.lt(l.eval[V], r.eval[V])
      case Lte02(l: V0, r: V2) => Nd4jUtil.gte(r.eval[V], l.eval[T])
      case Lte20(l: V2, r: V0) => Nd4jUtil.lte(l.eval[V], r.eval[T])
      case Lte22(l: V2, r: V2) => Nd4jUtil.lte(l.eval[V], r.eval[V])
      case Gt02(l: V0, r: V2)  => Nd4jUtil.lt(r.eval[V], l.eval[T])
      case Gt20(l: V2, r: V0)  => Nd4jUtil.gt(l.eval[V], r.eval[T])
      case Gt22(l: V2, r: V2)  => Nd4jUtil.gt(l.eval[V], r.eval[V])
      case Gte02(l: V0, r: V2) => Nd4jUtil.gte(r.eval[V], l.eval[T])
      case Gte20(l: V2, r: V0) => Nd4jUtil.gte(l.eval[V], r.eval[T])
      case Gte22(l: V2, r: V2) => Nd4jUtil.gte(l.eval[V], r.eval[V])
